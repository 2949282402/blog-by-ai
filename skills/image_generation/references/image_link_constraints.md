...
```markdown
![图片描述](https://mdn.alipayobjects.com/doraemon_plugin/afts/img/AAAA123456/original)
```
...
```markdown
# MCP 返回：https://mdn.alipayobjects.com/doraemon_plugin/afts/img/AAAA123456/original
# 错误输出：![图片描述](https://mdn.alipayobjects.com/doraemon_plugin/afts/img/AAAA123456/original?size=1024)
# ^^^^^^^^^^^ 添加了查询参数
```
...
```markdown
# MCP 返回：https://mdn.alipayobjects.com/doraemon_plugin/afts/img/AAAA123456/original
# 错误输出：![图片描述](https://mdn.alipayobjects.com/doraemon_plugin/afts/img/AAAA123456/original)
# ^^^^ 即使看起来一样，也必须逐字符核对
# 实际上可能一个 AAAA 是 4 个 A，另一个是 3 个 A + 1 个 A，必须完全一致
```
...
# 错误输出（使用了之前缓存的链接）：![图片描述](https://mdn.alipayobjects.com/doraemon_plugin/afts/img/OLD789012/original)
# ^^^ 严格禁止使用缓存的图片链接
# 必须每次都使用 skill 实时生成的图片链接
```
...
```
系统返回：https://mdn.alipayobjects.com/doraemon_plugin/afts/img/AAAA123456/original
输出链接：https://mdn.alipayobjects.com/doraemon_plugin/afts/img/AAAA123456/original
核对结果：✅ 完全一致
```
